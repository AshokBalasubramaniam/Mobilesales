...
import { homeSectionsStart, homeSectionsSuccess, homeSectionsFail, type HomeSections } from './slice';
...
export const fetchHomeSections = () => async (dispatch: Dispatch) => {
  try {
    ...
    const response = await api.get<ApiResponse<HomeSections>>('/mobiles/home-sections');
