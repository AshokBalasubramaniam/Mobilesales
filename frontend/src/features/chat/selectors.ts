...
export const selectOnlineUserIds = (state: RootState) => state.chat.onlineUserIds;
export const selectLastSeenByUserId = (state: RootState) => state.chat.lastSeenByUserId;

export const selectMessagesForConversation = (conversationId: string | undefined) => (state: RootState) =>
  (conversationId && state.chat.messagesByConversation[conversationId]) || [];

export const selectTypingForConversation = (conversationId: string | undefined) => (state: RootState) =>
