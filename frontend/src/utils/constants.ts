...
export const ROLES: Record<'BUYER' | 'SELLER' | 'ADMIN', Role> = { BUYER: 'buyer', SELLER: 'seller', ADMIN: 'admin' };
...
export const DELIVERY_STATUS_STEPS = ['pending', 'packed', 'shipped', 'out_for_delivery', 'delivered'] as const;
