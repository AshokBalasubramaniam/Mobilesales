  ...
  return (
    <div>
      <div
        ...
        onMouseDown={(e: MouseEvent<HTMLDivElement>) => spinMode && (dragStartX.current = e.clientX)}
        onMouseMove={(e: MouseEvent<HTMLDivElement>) => spinMode && handleDrag(e.clientX)}
        onMouseUp={() => (dragStartX.current = null)}
        onTouchStart={(e: TouchEvent<HTMLDivElement>) => spinMode && (dragStartX.current = e.touches[0].clientX)}
        onTouchMove={(e: TouchEvent<HTMLDivElement>) => spinMode && handleDrag(e.touches[0].clientX)}
