...
const classes = {
  ...
  addPhotoLabel:
    "flex size-20 cursor-pointer items-center justify-center rounded-lg border-2 border-dashed border-gray-300 text-gray-400",
  addPhotoIcon: "size-5",
  form: "space-y-4 rounded-2xl border border-gray-200 p-6",
