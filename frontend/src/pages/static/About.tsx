...
const About = () => (
  <StaticPage title="About Mobile Sales">
    ...
    <p>
      Every listing goes through an approval check, sellers can get verified
      with government ID and a selfie, and IMEI numbers can be checked before a
      sale — all to make buying a used phone feel as safe as buying a new one.
    </p>
  </StaticPage>
);
