...
export const listMyNotifications = asyncHandler(async (req: Request<unknown, unknown, unknown, NotificationListQuery>, res: Response) => {
...
export const markAsRead = asyncHandler(async (req: Request<ParamsDictionary>, res: Response) => {
...
export const deleteNotification = asyncHandler(async (req: Request<ParamsDictionary>, res: Response) => {
