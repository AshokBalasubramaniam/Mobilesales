...
const updateCoupon = {
  body: createCoupon.body.fork(Object.keys(createCoupon.body.describe().keys), (schema) => schema.optional()),
...
module.exports = { createCoupon, updateCoupon, applyCoupon, idParam };
