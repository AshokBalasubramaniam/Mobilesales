...
router.get('/seller/:id', optionalAuth, validate(reviewValidation.idParam), getSellerReviews);
router.get('/mobile/:id', optionalAuth, validate(reviewValidation.idParam), getMobileReviews);
